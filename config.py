...
__C.DATASETS.PASCAL3D.ANNOTATION_PATH       = '/drive/datasets/PASCAL3D/Annotations/%s_imagenet/%s.mat'
__C.DATASETS.PASCAL3D.RENDERING_PATH        = '/drive/datasets/PASCAL3D/Images/%s_imagenet/%s.JPEG'
__C.DATASETS.PASCAL3D.VOXEL_PATH            = '/drive/datasets/PASCAL3D/CAD/%s/%02d.binvox'
...
__C.DIR.RANDOM_BG_PATH                      = '/drive/Datasets/Image/Img001'
